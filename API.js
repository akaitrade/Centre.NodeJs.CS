...
var API_ActualFeeGet_args = function(args) {
...
var API_ActualFeeGet_result = function(args) {
  this.success = null;
  if (args) {
...
var API_FilteredTransactionsListGet_args = function(args) {
...
var API_FilteredTransactionsListGet_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
...
API_ContractAllMethodsGet_args.prototype.write = function(output) {
  ...
  if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
    ...
    for (var iter210 in this.byteCodeObjects) {
...
APIClient.prototype.ActualFeeGet = function(transactionSize, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_ActualFeeGet(transactionSize);
...
APIClient.prototype.send_ActualFeeGet = function(transactionSize) {
...
APIClient.prototype.recv_ActualFeeGet = function(input,mtype,rseqid) {
...
APIClient.prototype.FilteredTransactionsListGet = function(generalQuery, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_FilteredTransactionsListGet(generalQuery);
    return _defer.promise;
  } else {
    this._reqs[this.seqid()] = callback;
    this.send_FilteredTransactionsListGet(generalQuery);
...
APIClient.prototype.send_FilteredTransactionsListGet = function(generalQuery) {
  var output = new this.pClass(this.output);
  var params = {
...
APIClient.prototype.recv_FilteredTransactionsListGet = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
...
APIProcessor.prototype.process_ActualFeeGet = function(seqid, input, output) {
  var args = new API_ActualFeeGet_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.ActualFeeGet.length === 1) {
    Q.fcall(this._handler.ActualFeeGet.bind(this._handler),
      args.transactionSize
    ).then(function(result) {
      var result_obj = new API_ActualFeeGet_result({success: result});
    ...
    this._handler.ActualFeeGet(args.transactionSize, function (err, result) {
      var result_obj;
...
APIProcessor.prototype.process_WalletDataGet = function(seqid, input, output) {
  ...
  if (this._handler.WalletDataGet.length === 1) {
    Q.fcall(this._handler.WalletDataGet.bind(this._handler),
      args.address
    ).then(function(result) {
...
APIProcessor.prototype.process_WalletIdGet = function(seqid, input, output) {
  ...
  if (this._handler.WalletIdGet.length === 1) {
    Q.fcall(this._handler.WalletIdGet.bind(this._handler),
      args.address
    ).then(function(result) {
...
APIProcessor.prototype.process_WalletTransactionsCountGet = function(seqid, input, output) {
  ...
  if (this._handler.WalletTransactionsCountGet.length === 1) {
    Q.fcall(this._handler.WalletTransactionsCountGet.bind(this._handler),
      args.address
    ).then(function(result) {
...
APIProcessor.prototype.process_WalletBalanceGet = function(seqid, input, output) {
  ...
  if (this._handler.WalletBalanceGet.length === 1) {
    Q.fcall(this._handler.WalletBalanceGet.bind(this._handler),
      args.address
    ).then(function(result) {
...
APIProcessor.prototype.process_FilteredTransactionsListGet = function(seqid, input, output) {
  var args = new API_FilteredTransactionsListGet_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.FilteredTransactionsListGet.length === 1) {
    Q.fcall(this._handler.FilteredTransactionsListGet.bind(this._handler),
      args.generalQuery
    ).then(function(result) {
      var result_obj = new API_FilteredTransactionsListGet_result({success: result});
    ...
    this._handler.FilteredTransactionsListGet(args.generalQuery, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
...
APIProcessor.prototype.process_TransactionsStateGet = function(seqid, input, output) {
  ...
  if (this._handler.TransactionsStateGet.length === 2) {
    Q.fcall(this._handler.TransactionsStateGet.bind(this._handler),
      args.address,
      args.id
    ).then(function(result) {
...
APIProcessor.prototype.process_ContractAllMethodsGet = function(seqid, input, output) {
  ...
  if (this._handler.ContractAllMethodsGet.length === 1) {
    Q.fcall(this._handler.ContractAllMethodsGet.bind(this._handler),
...
APIProcessor.prototype.process_TokenTransferGet = function(seqid, input, output) {
  ...
  if (this._handler.TokenTransferGet.length === 2) {
    Q.fcall(this._handler.TokenTransferGet.bind(this._handler),
      args.token,
      args.id
    ).then(function(result) {
...
APIProcessor.prototype.process_TrustedGet = function(seqid, input, output) {
  ...
  if (this._handler.TrustedGet.length === 1) {
    Q.fcall(this._handler.TrustedGet.bind(this._handler),
      args.page
    ).then(function(result) {
...
APIProcessor.prototype.process_ExecuteCountGet = function(seqid, input, output) {
  ...
  if (this._handler.ExecuteCountGet.length === 1) {
    Q.fcall(this._handler.ExecuteCountGet.bind(this._handler),
      args.executeMethod
    ).then(function(result) {
